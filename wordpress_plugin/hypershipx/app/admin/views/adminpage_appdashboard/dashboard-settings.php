...
<div class="hypership-card">
  ...
  <div class="support-section"
    ...
    <h3 style="margin-top: 0; margin-bottom: 15px; font-size: 16px; color: #333;">Need Help with HyperShip? Contact Support</h3>
    ...
    <form id="support-form" style="display: flex; flex-direction: column; gap: 15px;">
      ...
      <div class="form-group">
        <label for="support-type" style="display: block; margin-bottom: 5px; font-weight: 500;">Type of Message</label>
